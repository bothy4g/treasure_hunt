<?php
if (!function_exists('_25482cb811b6b3f17f11f8ed4748c8f7')):
function _25482cb811b6b3f17f11f8ed4748c8f7($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if (isset($label) || isset($description) || isset($descriptionTrailing)): ?>
    ...
    ?>
    <?php if (!function_exists('_d5cc101bbea8e708bf10883800fde797')) { $__blaze->compile('/var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/field.blade.php', $__blaze->compiledPath.'/d5cc101bbea8e708bf10883800fde797.php'); require $__blaze->compiledPath.'/d5cc101bbea8e708bf10883800fde797.php'; } ?>
...
<?php ob_start(); ?>
        <?php if (isset($label)): ?>
            <?php if (!function_exists('_b365cc769c4f8a5b11cbabafa044a19e')) { $__blaze->compile('/var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/label.blade.php', $__blaze->compiledPath.'/b365cc769c4f8a5b11cbabafa044a19e.php'); require $__blaze->compiledPath.'/b365cc769c4f8a5b11cbabafa044a19e.php'; } ?>
...
<?php ob_start(); ?><?php echo e($label); ?><?php $__slotsb365cc769c4f8a5b11cbabafa044a19e['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsb365cc769c4f8a5b11cbabafa044a19e); ?>
<?php _b365cc769c4f8a5b11cbabafa044a19e($__blaze, $__attrsb365cc769c4f8a5b11cbabafa044a19e, $__slotsb365cc769c4f8a5b11cbabafa044a19e, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?>
        ...
        <?php if (isset($description)): ?>
            <?php if (!function_exists('_5254cf35146fe4fb874bc8e717224408')) { $__blaze->compile('/var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/description.blade.php', $__blaze->compiledPath.'/5254cf35146fe4fb874bc8e717224408.php'); require $__blaze->compiledPath.'/5254cf35146fe4fb874bc8e717224408.php'; } ?>
...
<?php ob_start(); ?><?php echo e($description); ?><?php $__slots5254cf35146fe4fb874bc8e717224408['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots5254cf35146fe4fb874bc8e717224408); ?>
<?php _5254cf35146fe4fb874bc8e717224408($__blaze, $__attrs5254cf35146fe4fb874bc8e717224408, $__slots5254cf35146fe4fb874bc8e717224408, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?>
        ...
        <?php if (!function_exists('_0a6ca035f5897ed47ee6e9ef47f32226')) { $__blaze->compile('/var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/error.blade.php', $__blaze->compiledPath.'/0a6ca035f5897ed47ee6e9ef47f32226.php'); require $__blaze->compiledPath.'/0a6ca035f5897ed47ee6e9ef47f32226.php'; } ?>
<?php $__blaze->pushData(['attributes' => new \Illuminate\View\ComponentAttributeBag($scope['attributes'])]); ?>
<?php _0a6ca035f5897ed47ee6e9ef47f32226($__blaze, ['attributes' => new \Illuminate\View\ComponentAttributeBag($scope['attributes'])], [], ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php $__slots5254cf35146fe4fb874bc8e717224408 = []; ?>
<?php $__blaze->pushData($__attrs5254cf35146fe4fb874bc8e717224408); ?>
<?php ob_start(); ?><?php echo e($descriptionTrailing); ?><?php $__slots5254cf35146fe4fb874bc8e717224408['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots5254cf35146fe4fb874bc8e717224408); ?>
<?php _5254cf35146fe4fb874bc8e717224408($__blaze, $__attrs5254cf35146fe4fb874bc8e717224408, $__slots5254cf35146fe4fb874bc8e717224408, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack5254cf35146fe4fb874bc8e717224408)) { $__slots5254cf35146fe4fb874bc8e717224408 = array_pop($__slotsStack5254cf35146fe4fb874bc8e717224408); } ?>
<?php if (! empty($__attrsStack5254cf35146fe4fb874bc8e717224408)) { $__attrs5254cf35146fe4fb874bc8e717224408 = array_pop($__attrsStack5254cf35146fe4fb874bc8e717224408); } ?>
<?php $__blaze->popData(); ?>
        <?php endif; ?>
    <?php $__slotsd5cc101bbea8e708bf10883800fde797['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsd5cc101bbea8e708bf10883800fde797); ?>
<?php _d5cc101bbea8e708bf10883800fde797($__blaze, $__attrsd5cc101bbea8e708bf10883800fde797, $__slotsd5cc101bbea8e708bf10883800fde797, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
