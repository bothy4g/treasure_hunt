<div class="rounded-lg border border-neutral-300 dark:border-neutral-600 bg-neutral-50 dark:bg-zinc-800 p-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>
            ...
            <p class="font-medium text-neutral-900 dark:text-neutral-100">{{ $character->cultural_temptation_resistance }}</p>
        </div>
        <div>
            <span class="text-sm text-neutral-600 dark:text-neutral-400">Faith Resistance:</span>
            <p class="font-medium text-neutral-900 dark:text-neutral-100">{{ $character->faith_temptation_resistance }}</p>
        </div>
        <div>
            <span class="text-sm text-neutral-600 dark:text-neutral-400">Social Resistance:</span>
            <p class="font-medium text-neutral-900 dark:text-neutral-100">{{ $character->social_temptation_resistance }}</p>
        </div>
        <div>
            <span class="text-sm text-neutral-600 dark:text-neutral-400">Economic Resistance:</span>
            <p class="font-medium text-neutral-900 dark:text-neutral-100">{{ $character->economical_temptation_resistance }}</p>
        </div>
    </div>
</div>