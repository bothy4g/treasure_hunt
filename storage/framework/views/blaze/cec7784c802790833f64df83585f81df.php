<?php
if (!function_exists('__cec7784c802790833f64df83585f81df')):
function __cec7784c802790833f64df83585f81df($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if ($toggleable): ?>
    <ui-dropdown position="<?php echo e($position); ?> <?php echo e($align); ?>" <?php echo e($attributes); ?> data-flux-tooltip>
        ...
        <?php if ($content !== null): ?>
            <?php if (!function_exists('__20d4ab197c079044706402eacf43856f')) { $__blaze->compile('/var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/tooltip/content.blade.php', $__blaze->compiledPath.'/20d4ab197c079044706402eacf43856f.php'); require $__blaze->compiledPath.'/20d4ab197c079044706402eacf43856f.php'; } ?>
...
<?php ob_start(); ?><?php echo e($content); ?><?php $__slots20d4ab197c079044706402eacf43856f['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots20d4ab197c079044706402eacf43856f); ?>
<?php __20d4ab197c079044706402eacf43856f($__blaze, $__attrs20d4ab197c079044706402eacf43856f, $__slots20d4ab197c079044706402eacf43856f, ['kbd'], [], $__this ?? (isset($this) ? $this : null)); ?>
