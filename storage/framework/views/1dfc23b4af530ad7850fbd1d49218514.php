<?php # [BlazeFolded]:{flux::icon.chevron-down}:{/var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/chevron-down.blade.php}:{1787062569} ?>
<?php # [BlazeFolded]:{flux::icon.chevron-right}:{/var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/chevron-right.blade.php}:{1787062569} ?>
...
<?php # [BlazeFolded]:{flux::icon.chevron-right}:{/var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/chevron-right.blade.php}:{1787062569} ?>
<?php
if (!function_exists('_1dfc23b4af530ad7850fbd1d49218514')):
function _1dfc23b4af530ad7850fbd1d49218514($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _4e4d6afd7c6fbc3d5b206b4f5ac16211($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => 'size-4'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _4e4d6afd7c6fbc3d5b206b4f5ac16211($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => 'in-data-flux-menu:text-zinc-400 in-data-flux-menu:dark:text-white/80 in-data-flux-menu:[[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current size-4'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
                        <?php else: ?>
                            <?php echo e($icon); ?>
                ...
                <div class="hidden in-data-flux-menu:block">
                    <?php if (!function_exists('_6fd95ef6191c303c1de170259f328612')) { $__blaze->compile('/var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/chevron-right.blade.php', $__blaze->compiledPath.'/6fd95ef6191c303c1de170259f328612.php'); require $__blaze->compiledPath.'/6fd95ef6191c303c1de170259f328612.php'; } ?>
...
<?php _6fd95ef6191c303c1de170259f328612($__blaze, ['variant' => $iconVariant,'class' => 'ms-auto size-4 text-zinc-400 [[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current rtl:hidden'], [], ['variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php if (!function_exists('_a37b453efc29cf39d7248b815effe529')) { $__blaze->compile('/var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/chevron-left.blade.php', $__blaze->compiledPath.'/a37b453efc29cf39d7248b815effe529.php'); require $__blaze->compiledPath.'/a37b453efc29cf39d7248b815effe529.php'; } ?>
...
<?php _a37b453efc29cf39d7248b815effe529($__blaze, ['variant' => $iconVariant,'class' => 'ms-auto size-4 text-zinc-400 [[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current hidden rtl:inline'], [], ['variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                </div>
            </button>
...
>
    <?php ob_start(); ?>
                <?php if (!function_exists('_68516b29f905d7dc1397c88235884e30')) { $__blaze->compile('/var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/menu/group.blade.php', $__blaze->compiledPath.'/68516b29f905d7dc1397c88235884e30.php'); require $__blaze->compiledPath.'/68516b29f905d7dc1397c88235884e30.php'; } ?>
<?php if (isset($__slots68516b29f905d7dc1397c88235884e30)) { $__slotsStack68516b29f905d7dc1397c88235884e30[] = $__slots68516b29f905d7dc1397c88235884e30; } ?>
<?php if (isset($__attrs68516b29f905d7dc1397c88235884e30)) { $__attrsStack68516b29f905d7dc1397c88235884e30[] = $__attrs68516b29f905d7dc1397c88235884e30; } ?>
<?php $__attrs68516b29f905d7dc1397c88235884e30 = ['heading' => $heading]; ?>
<?php $__slots68516b29f905d7dc1397c88235884e30 = []; ?>
<?php $__blaze->pushData($__attrs68516b29f905d7dc1397c88235884e30); ?>
<?php ob_start(); ?>
                    <?php echo e($slot); ?>

                <?php $__slots68516b29f905d7dc1397c88235884e30['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots68516b29f905d7dc1397c88235884e30); ?>
<?php _68516b29f905d7dc1397c88235884e30($__blaze, $__attrs68516b29f905d7dc1397c88235884e30, $__slots68516b29f905d7dc1397c88235884e30, ['heading'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack68516b29f905d7dc1397c88235884e30)) { $__slots68516b29f905d7dc1397c88235884e30 = array_pop($__slotsStack68516b29f905d7dc1397c88235884e30); } ?>
<?php if (! empty($__attrsStack68516b29f905d7dc1397c88235884e30)) { $__attrs68516b29f905d7dc1397c88235884e30 = array_pop($__attrsStack68516b29f905d7dc1397c88235884e30); } ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH /var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/sidebar/group.blade.php ENDPATH**/ ?>