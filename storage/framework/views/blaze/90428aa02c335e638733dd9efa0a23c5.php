<?php
if (!function_exists('__90428aa02c335e638733dd9efa0a23c5')):
function __90428aa02c335e638733dd9efa0a23c5($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if ($collapsibleOnMobile): ?>
    <?php if (!function_exists('__2dd2512e8651a590e57584f73abaddd3')) { $__blaze->compile('/var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/sidebar/backdrop.blade.php', $__blaze->compiledPath.'/2dd2512e8651a590e57584f73abaddd3.php'); require $__blaze->compiledPath.'/2dd2512e8651a590e57584f73abaddd3.php'; } ?>
<?php $__blaze->pushData([]); ?>
<?php __2dd2512e8651a590e57584f73abaddd3($__blaze, [], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
<?php endif; ?>
...
} endif; ?><?php /**PATH /var/www/html/vendor/livewire/flux/src/../stubs/resources/views/flux/sidebar/index.blade.php ENDPATH**/ ?>